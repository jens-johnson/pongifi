 ...
 *
 * █████████████████████████████████████████████████████████████████████████████████████████████████████████████████████
 * ███████████████████████████████ #components/widgets/account/google-command/index.vue ████████████████████████████████
 *
 * The Continue with Google command, carrying a validated return path.
 *
 * ─── USAGE ───────────────────────────────────────────────────────────────────────────────────────────────────────────
 *
 ...
 *
 *   • href
 *     - Description: the Google handler URL, with a validated same-origin return path when there is one
 *     - Type: string
 *     - Required: true
 *
 * █████████████████████████████████████████████████████████████████████████████████████████████████████████████████████
...
import type { IAccountGoogleCommandProps } from './types';

/* ─── Props ──────────────────────────────────────────────────────────────────────────────────────────────────────── */

/**
 * Where the command sends the visitor.
 * @internal
 * @constant
 */
const props: Readonly<IAccountGoogleCommandProps> = defineProps<IAccountGoogleCommandProps>();
</script>
